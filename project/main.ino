...
//TM1637Display display(5,16); // D0, D1
//TM1637Display display(11, 12); // S2, S3
//TM1637Display display(1, 3); // RX, TX
//TM1637Display display(6,7); // D0, D1
...
void setup() {
  ...
  calibrateDistance();
  Serial.print("Sensor1 threshold set to: ");
  Serial.println(sensor1Initial);
  Serial.print("Sensor2 threshold set to: ");
  ...
  server.on("/led_set", max_people_control);
  server.begin();
...
void calibrateDistance() {
  ...
  digitalWrite(LED_WAIT, HIGH); digitalWrite(LED_ENTER, HIGH);
  ...
  digitalWrite(LED_WAIT, LOW); digitalWrite(LED_ENTER, LOW); 
}
// --------------------------------------------------------------------------------------
